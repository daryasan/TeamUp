...
public class ReviewControllerTest {
    ...
    public void add_review_valid_add_review() throws Exception {
        ...
        given(reviewService.addReview("dummy-token", userId, createReviewDto))
                .willReturn(dummyReview);

        mockMvc.perform(post("/reviews/add?userId={userId}", userId)
    ...
    public void find_review_by_id_valid_find_review() throws Exception {
        ...
        mockMvc.perform(get("/reviews/id").param("id", reviewId.toString())
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    public void edit_review_valid_edit_review() throws Exception {
        ...
        given(reviewService.editReview(eq(reviewId), any(CreateReviewDto.class)))
    ...
    public void get_user_reviews_valid_get_reviews() throws Exception {
        ...
        mockMvc.perform(get("/reviews/by-user")
    ...
    public void get_user_rate_valid_get_rating() throws Exception {
        ...
        mockMvc.perform(get("/reviews/by-user/rating")
                        .param("userId", userId.toString())
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
